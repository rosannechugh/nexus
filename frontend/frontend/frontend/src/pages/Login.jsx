...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const message = getAuthErrorMessage(err, { context: "login" });
      setError(message);
      // Network/connectivity failures deserve a toast (no inline form
      // field is "wrong" the way a bad password is) — validation-style
      // errors stay inline only, to avoid double-messaging the same thing.
      if (!err.response) showToast(message, "error");
    } finally {
